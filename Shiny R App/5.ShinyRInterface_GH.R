...
# This code was reviewed for last time on 01/12/21
# This code builds the functions used in the Shiny R interface
# Inspired in https://shiny.rstudio.com/gallery/covid19-tracker.html and
...
setwd("") #UPDATE THIS LINE WITH THE FILE DIRECTORY
source("4.ShinyRSource_GH.R")
